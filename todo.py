...
my_list = Listbox(my_frame, font=my_font, width=38, height=6, bg="#cf9fff", bd=0, fg="#5c4033", highlightthickness=0, selectbackground="#ff0000", activestyle="none")
...
my_entry = Entry(root, font=("Arial", 21), width=27, bg='#cf9fff')
my_entry.pack(pady=22)

button_frame = Frame(root, bg='#FFC0CB')
...
def uncross_item():
    my_list.itemconfig(my_list.curselection(), fg="#9F2B68")
    my_list.selection_clear(0, END)
